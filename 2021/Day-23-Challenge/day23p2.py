...
def main():
    ...
    room_rows = [line for line in lines
                 if any(c in 'ABCD' for c in line)]

    # insert the two extra rows for part 2
    room_rows.insert(1, '  #D#C#B#A#')
    room_rows.insert(2, '  #D#B#A#C#')
